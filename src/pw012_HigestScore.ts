...
(async () => {
  ...
  await page.goto(
    "https://www.espncricinfo.com/series/pakistan-super-league-2026-1515734/karachi-kings-vs-peshawar-zalmi-17th-match-1527568/full-scorecard",
    { waitUntil: "load" },
  );

  let allScores: string[] = await page
    .locator(
      `//span[text()= 'Peshawar Zalmi']/ancestor::div[contains(@class, 'ds-bg-color-primary-bg ds-p-3')]/following-sibling::div/table[contains(@class, 'ci-scorecard-table')]//tr/td[3]`,
    )
    .allInnerTexts();
